...
import { type ClinicalContextRepository, type FhirResource, type PatientContext } from "../ports.js";
...
function buildPrefillSummary(context: PatientContext): PrefillSummary[] {
  return [
    context.patient && {
      linkId: "patient-name",
