...
This project is indexed by GitNexus as **Open_Prior_Auth_Workbench** (2783 symbols, 5930 relationships, 232 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Open_Prior_Auth_Workbench/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Open_Prior_Auth_Workbench/clusters` | All functional areas |
| `gitnexus://repo/Open_Prior_Auth_Workbench/processes` | All execution flows |
| `gitnexus://repo/Open_Prior_Auth_Workbench/process/{name}` | Step-by-step execution trace |
